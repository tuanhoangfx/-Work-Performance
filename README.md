...
-- ==============================================================
-- 3. FUNCTIONS & TRIGGERS (CREATE OR REPLACE + CHECK TRIGGER)
-- ==============================================================
...
-- ==============================================================
-- 4. RLS POLICIES (DROP + CREATE ĐỂ TRÁNH LỖI TRÙNG)
-- ==============================================================
...
CREATE POLICY "Users can manage attachments for tasks they can access." ON public.task_attachments
  FOR ALL USING (
    EXISTS (SELECT 1 FROM public.tasks t WHERE t.id = task_attachments.task_id AND (t.user_id = auth.uid() OR t.created_by = auth.uid()))
  );
...
CREATE POLICY "Authenticated users can view all comments." ON public.task_comments
  FOR SELECT USING (auth.role() = 'authenticated');
